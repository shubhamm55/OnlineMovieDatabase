				...
				echo      '  
							<div class="col-md-2">
							 ...
							 <div class="col-md-10 movie-info">
									<h3><u>'. $movie->getTitle() .'</u></h3>
									<br>
									<h4>'. $movie->getTagline() .'</h4>
									<!--Genre Code HERE-->
									<h4><span><img style="height:20px;width:35px;position:relative;bottom:3px;"src="Images/imdb.png"></span> Rating : '. $movie->getVoteAverage() .'   <span class="glyphicon glyphicon-star"></span></h4>
									<br>
									<h4>Rate the movie : <fieldset class="rating">
