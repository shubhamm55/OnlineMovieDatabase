	...
	<body class="mystyle">
		...
		<div class="container">
			...
			<div class="profileBox" style="font-size: 30px;position: relative;height: 450px;widht: 100%">
				<img class="img-responsive" src="Images/user.png" alt="User Pic here" height="400px" width="400px">
		...
		<div id="update" class="modal fade" role="dialog">
			<div class="modal-dialog">
		        	...
		        	<div class="modal-body" style="color: #ffe695;background-color: maroon;position: relative">
		        		<form id="rtpwd" method="POST" action="Update.php">
        					<div style="position: relative">
		                        ...
		                        <p class="validate" id="chkfname" size="32" style="position: absolute;top: 35px"></p>
	                    	</div>
	    					<div style="position: relative">                	
							  	<div style="margin-bottom: 25px" class="input-group">
				...
				<div>
					<a href="#" data-html='true' data-toggle="popover" title='Change Password' data-content='<form><input  style="color:black" type="text">Enter Old Password<br><br>
					<input  style="color:black" type="text">Enter New Password<br><button type="submit" class="btn btn-primary">Submit</button></form>'>Change Password</a>
		      	        </div>
				</div>
