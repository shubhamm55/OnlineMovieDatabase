...
<html>
				...
				echo      '  
							<div class="col-md-2">
							 ...
							 <div class="col-md-10 movie-info">
									<h3><u>'. $tvShow->getName() .'</u></h3>
									<br>
									<h4>'. $tvShow->getOverview() .'</h4>
									<!--Genre Code HERE-->
									<h4><span><img style="height:20px;width:35px;position:relative;bottom:3px;"src="Images/imdb.png"></span> Rating : '. $tvShow->getVoteAverage() .'   <span class="glyphicon glyphicon-star"></span></h4>
									<br>
									<h4>Rate the tvShow : <fieldset class="rating">
    ...
    <input type="radio" id="starhalf" name="rating" value="half" /><label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label>
									...
									<button type="submit" class="btn wish">Add To Wishlist <span class="glyphicon glyphicon-plus"></span></button>
