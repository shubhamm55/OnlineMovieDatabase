			...
			<div class="modal-dialog">
				<div class="modal-content">
		        	...
		        	<div class="modal-body" style="color: #ffe695;background-color: maroon;position: relative">
		      		...
		      		<div class="modal-footer" style="background-color: #ffe695">
		        		<button id="close" type="button" class="btn btn-default" data-dismiss="modal" style="background-color: maroon;color: white">Close</button>
		    		</div>
	    		</div>
			</div>
		</div>
