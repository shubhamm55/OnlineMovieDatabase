...
<html lang="en">
	...
	<body style="background-image: url(Images/backdrop.jpg);background-repeat: no-repeat;background-size: 100% 100%;font-family: 'Lobster Two'">
			...
			<div class="panel panel-default" style="background: rgba(255,255,255,0.5)">
	  			<div class="panel-body">
					...
					<div id="message" style="position: absolute;top: 280px;left: 60px">
						<p style="font-size: 15px">Don't have an account? <a id="joinus" href="Sign_Up.html">JOIN US</a></p>
					</div>
	 			</div>
			</div>
			...
			<div id="frgtpwd" class="modal fade" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
		      			<div class="modal-header" style="background-color: black;color: #ffe695">
		    				<button type="button" class="close" data-dismiss="modal" style="color: white">&times;</button>
		        			<h4 class="modal-title">Password Retrieval</h4>
		    			</div>
			        	<div class="modal-body" style="background-color: maroon;position: relative">
			        		<br>
			        		<form class="form-inline" id="rtpwd" method="POST" action="Forgot_Password_Process.php">
	        					<div style="margin-bottom: 25px" class="form-group">
	        						<p id="success" style="font-size: 30px;position: absolute;top: 20px;left: 50px;display: none"></p>
	                            	<label id="label" for="username" style="font-size: 20px;position: absolute;top: 20px;left: 40px">Username: </label>
	                        		...
	                        		<p id="alert"></p>
	                        		<button id="enter" class="btn btn-default" type="button" onclick="chkpwd(this)" style="background-color: #ffe695">RETRIEVE</button>
	                        	</div>
                        	</form>
			      		</div>
			      		<div class="modal-footer" style="background-color: black">
			        		<button type="button" class="btn btn-default" data-dismiss="modal" style="color: black;background-color: #ffe695">Close</button>
			    		</div>
		    		</div>
				</div>
			</div>
